# 🧮 Advanced Math Game Console Application

> An advanced, interactive console-based mathematics practice application with
> dynamic difficulty levels and personalized user experience Upgrade of the This
> is an upgrade of the
> [basic C# Math Game](https://github.com/JonesKwameOsei/MathsGame) 🎮
...
1. **Splash Screen** → Personalized welcome with motivational content
...
**Target Audience**: Advanced students, adult learners, competitive practice
...
- **Arithmetic Fluency**: Build speed and accuracy in fundamental operations
...
_Developed with ❤️ using C# and .NET - Advanced Education Technology_
...
> Note: For the best User Experience, this game is best played on a unix
